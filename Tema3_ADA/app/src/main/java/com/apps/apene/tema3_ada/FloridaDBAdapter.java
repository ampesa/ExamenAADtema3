...
public class FloridaDBAdapter {
    ...
    private static final String SQL_CREATE_TABLE_STUDENTS =
            "CREATE TABLE " + FloridaDBAdapter.TABLE_STUDENTS + " (_Id integer primary key autoincrement," +
                    FloridaDBAdapter.KEY_NAME + TEXT_TYPE + COMMA_SEP +
                    FloridaDBAdapter.KEY_AGE + TEXT_TYPE + COMMA_SEP +
                    FloridaDBAdapter.KEY_GRADE + TEXT_TYPE + COMMA_SEP +
                    FloridaDBAdapter.KEY_COURSE + TEXT_TYPE + COMMA_SEP +
                    FloridaDBAdapter.KEY_AVERAGE + TEXT_TYPE + " )";

    // Creación de la tabla profesores
    private static final String SQL_CREATE_TABLE_LECTURERS =
            "CREATE TABLE " + FloridaDBAdapter.TABLE_LECTURERS + " (_Id integer primary key autoincrement," +
                    FloridaDBAdapter.KEY_NAME + TEXT_TYPE + COMMA_SEP +
                    FloridaDBAdapter.KEY_AGE + TEXT_TYPE + COMMA_SEP +
                    FloridaDBAdapter.KEY_GRADE + TEXT_TYPE + COMMA_SEP +
                    FloridaDBAdapter.KEY_COURSE + TEXT_TYPE + COMMA_SEP +
                    FloridaDBAdapter.KEY_OFFICE_NUMBER + TEXT_TYPE + " )";

    private static final String SQL_DELETE_TABLE_STUDENTS
            = "DROP TABLE IF EXISTS " + FloridaDBAdapter.TABLE_STUDENTS;

    private static final String SQL_DELETE_TABLE_LECTURERS
            = "DROP TABLE IF EXISTS " + FloridaDBAdapter.TABLE_LECTURERS;
    ...
    public ArrayList<String> getAll(){
           ...
           ArrayList<String> students = getAllStudents();
           ArrayList<String> lecturers = getAllLecturers();
